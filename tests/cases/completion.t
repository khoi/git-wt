...
assert_match "switch sw exec sync ls archive unarchive rm merge here base root help completion" "$out"
...
assert_match "save workspace state and remove worktree" "$out"
